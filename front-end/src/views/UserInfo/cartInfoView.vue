        ...
        <div class="container mx-auto max-w-7xl">
            <div class="w-full flex flex-col items-center justify-cente">
                <div class="w-[90%] flex flex-col items-center justify-center pt-12 2xl:pt-8">
                    ...
                    <form class=" w-full md:w-[674px] flex flex-col justify-start items-atart">
                        ...
                        <input type="text" class="appearance-none py-4 px-8 mt-4 mb-[32px] rounded-full bg-[#F0F9FF] placeholder:text-[#6192BF] md:text-[20px] text-sm focus:bg-[#E4F3FF] active:bg-[#E4F3FF] active:border active:border-[#1E94FD] focus:border focus:border-[#1E94FD] focus:outline focus:outline-0">
                        ...
                        <div class="w-1/2">
                            ...
                            <div class="w-full flex flex-row">
                                <select type="text" class="appearance-none py-4 px-8 mt-4 mb-[32px] w-1/2 rounded-l-full bg-[#F0F9FF] placeholder:text-[#6192BF] md:text-[20px] text-sm focus:bg-[#E4F3FF] active:bg-[#E4F3FF] active:border active:border-[#1E94FD] focus:border focus:border-[#1E94FD] focus:outline focus:outline-0">
                                    <option v-for="mounth in mounths">{{mounth}}</option>
                                </select>
                                <select v-model="getYears"  type="text" class="appearance-none py-4 px-8 mt-4 mb-[32px] w-1/2 rounded-r-full border border-[#D3D3D3] bg-[#F0F9FF] placeholder:text-[#6192BF] md:text-[20px] text-sm focus:bg-[#E4F3FF] active:bg-[#E4F3FF] active:border active:border-[#1E94FD] focus:border focus:border-[#1E94FD] focus:outline focus:outline-0">
                                    <option>2023</option>
                        ...
                        <div class="w-1/3 flex flex-col justify-end itemes-end">
                            ...
                            <input value="cvv" class="appearance-none py-4 px-8 mt-4 mb-[32px] w-full rounded-full bg-[#F0F9FF] placeholder:text-[#6192BF] md:text-[20px] text-sm focus:bg-[#E4F3FF] active:bg-[#E4F3FF] active:border active:border-[#1E94FD] focus:border focus:border-[#1E94FD] focus:outline focus:outline-0">
                        </div>
