        ...
        <div class="w-full flex flex-row">
          <div class="w-3/4">
            ...
            >
              ...
              >
                ...
                <p
                  class="w-1/5 text-center font-medium text-[10px] md:text-[18px]"
                >
                  {{ prodact.produit }}
                </p>
                <div class="w-1/6">
          ...
          <div class="p-4 w-1/4 flex flex-col items-start text-[#5A7BA0]">
            <img
              ...
              alt=""
            />
            <p class="py-4 w-full font-medium md:text-[22px]" v-if="selectedProdact != null">
              {{ selectedProdact.produit }}
            </p>
          </div>
        </div>
        <div class="w-full flex items-center justify-between pt-8 md:pl-10 pl-5 md:pr-52 pr-0">
                        <div>
                            <h3 class="md:text-base text-sm font-semibold text-dark-blue">TOTAL = 1 080.00 DHS</h3>
                        </div>
                        <div>
                            <button 
                            :class="prodactselected.length === 0 ? 'cursor-default pointer-events-none opacity-50' : ''"
...
function addToCart(item){
    return prodactselected.push(item)
}
