<template>
    <div class="w-[60%] flex flex-col items-center justify-center space-y-8">
        <div class="bg-white-color w-[60%] h-[440px] rounded-3xl pt-4 pb-10">
            <h1 class="text-dark-blue font-bold text-[40px] pb-5 pl-8">Panier</h1>
            <div class="max-h-[290px] w-[92%] overflow-y-scroll">
                <div class="flex flex-col w-full items-start justify-center px-8 space-y-5">
                    <!--Livre-->
                    <div v-if="getLivres" class="w-full flex items-center justify-between">
                        <div>
                            <img src="../../assets/latin.png" class="w-10" alt="livre">
                        </div>
                        <div class="flex flex-col text-dark-blue space-y-1">
                            <div>
                                <p class="text-xs font-semibold">Manuels</p>
                            </div>
                        ...
                        <div>
                            <button @click="deleteLivre()" class="uppercase text-dark-blue text-[10px] pt-6 pl-3">supprimer</button>
                        </div>
                        <div>
                            <p class="text-[13px] font-bold text-dark-blue pt-5">{{getTotalLivre + secondData.plastificationTotal}},00 <span class="font-medium">MAD</span></p>
                        </div>
                    ...
                    <div v-if="getProducts" class="w-full flex items-center justify-between">
                        <div>
                            <img src="../../assets/Calligraphe.svg" class="w-10" alt="livre">
                        </div>
                        <div class="flex flex-col text-dark-blue space-y-1">
                            <div>
                                <p class="text-xs font-semibold">Fournitures</p>
                            </div>
                            <router-link to="/Livres-Fourniture">
                                <div class="border-[0.5px] border-[#6192BF] w-16 h-3.5 rounded-xl flex items-center cursor-pointer">
                                    <div class="w-full flex items-center justify-between px-1">
                        ...
                        <div>
                            <button @click="deleteFaurn()" class="uppercase text-dark-blue text-[10px] pt-6 pl-3">supprimer</button>
                        </div>
                        <div>
                            <p class="text-[13px] font-bold text-dark-blue pt-5">{{getTotalProduct}},00 <span class="font-medium">MAD</span></p>
                        </div>
                    ...
                    <div v-if="getFournitures('calculatrice')" class="w-full flex items-center justify-between">
                        ...
                        <div class="flex flex-col text-dark-blue space-y-1">
                            <div>
                                <p class="text-xs font-semibold">Calculatrice</p>
                            </div>
                        ...
                        <div>
                            <button @click="deleteProducts('calculatrice')" class="uppercase text-dark-blue text-[10px] pt-6 pl-3">supprimer</button>
                        </div>
                        <div>
                            <p class="text-[13px] font-bold text-dark-blue pt-5">{{ getTotalPrice('calculatrice') }},00 <span class="font-medium">MAD</span></p>
                        </div>
                    ...
                    <div v-if="getFournitures('cartable')" class="w-full flex items-center justify-between">
                        ...
                        <div class="flex flex-col text-dark-blue space-y-1">
                            <div>
                                <p class="text-xs font-semibold">Cartable</p>
                            </div>
                        ...
                        <div>
                            <button @click="deleteProducts('cartable')" class="uppercase text-dark-blue text-[10px] pt-6 pl-3">supprimer</button>
                        </div>
                        <div>
                            <p class="text-[13px] font-bold text-dark-blue pt-5">{{ getTotalPrice('cartable') }},00 <span class="font-medium">MAD</span></p>
                        </div>
                    ...
                    <div v-if="getFournitures('trousse')" class="w-full flex items-center justify-between">
                        ...
                        <div class="flex flex-col text-dark-blue space-y-1">
                            <div>
                                <p class="text-xs font-semibold">Trousse</p>
                            </div>
                        ...
                        <div>
                            <button @click="deleteProducts('trousse')" class="uppercase text-dark-blue text-[10px] pt-6 pl-3">supprimer</button>
                        </div>
                        <div>
                            <p class="text-[13px] font-bold text-dark-blue pt-5">{{ getTotalPrice('trousse') }},00 <span class="font-medium">MAD</span></p>
                        </div>
